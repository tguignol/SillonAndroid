...
android {
    ...
    defaultConfig {
        applicationId = "ch.kohlnet.sillon"
        minSdk = 33
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Lecture audio (+ session pour la lecture en arrière-plan / contrôles système)
    implementation(libs.androidx.media3.exoplayer)
    implementation(libs.androidx.media3.session)
    // Paroles : traduction + détection de langue sur l'appareil (ML Kit)
